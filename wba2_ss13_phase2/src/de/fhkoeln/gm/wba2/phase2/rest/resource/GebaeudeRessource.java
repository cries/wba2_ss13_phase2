...
public class GebaeudeRessource {
	...
	public Response getHeizung() {
		...
		if (heizung != null)
			return Response.ok().entity(heizung)
	...
	public Response getHeizungIst() {
		...
		return Response.ok().entity(heizungIst).type(MediaType.APPLICATION_XML)
				.build();
	}
	...
	@Path("/heizung/ist")
	@Consumes(MediaType.APPLICATION_XML)
	public Response updateHeizungIst(String body) {
		Boolean success = dh.updateHeizungIst(body);
		if (success)
			return Response.noContent().build();
		else {
			return Response.status(404).build();
	...
	public Response getHeizungSoll() {
		...
		return Response.ok().entity(heizungSoll)
				.type(MediaType.APPLICATION_XML).build();
	}
	...
	@Path("/heizung/soll")
	@Consumes(MediaType.APPLICATION_XML)
	public Response updateHeizungSoll(String body) {
		Boolean success = dh.updateHeizungSoll(body);
		if (success)
			return Response.noContent().build();
		else {
			return Response.status(404).build();
	...
	public Response getKameras() {
		...
		if (kameras != null)
			return Response.ok().entity(kameras)
					.type(MediaType.APPLICATION_XML).build();
		else
			return Response.status(404).build();
	}
	...
	@Path("/kamera/{kameraid}")
	@Consumes(MediaType.APPLICATION_XML)
	public Response updateKamera(@PathParam("kamerid") BigInteger kamera_id, String body) {
		Boolean success = dh.updateKamera(kamera_id, body);
		if (success)
			return Response.noContent().build();
		else {
			return Response.status(404).build();
	...
	@Path("/energie")
	@Consumes(MediaType.APPLICATION_XML)
	public Response updateEnergie(String body) {
		Boolean success = dh.updateEnergie(body);
		if (success)
			return Response.noContent().build();
		else {
			return Response.status(404).build();
